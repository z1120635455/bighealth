  ...
  <el-card class="box-card">
    ...
    <el-form :inline="true">
      <el-form-item label="就诊人">
        <el-select placeholder="请选择就诊人" style="width: 140px" v-model="patientId" @change="changeUser">
      ...
      <el-form-item label="订单状态">
        <el-select placeholder="请选择订单状态" style="width: 160px" v-model="orderStatus" @change="changeOrderState">
