  ...
  <div class="wrap">
    ...
    <div class="bottom">
      ...
      <div class="will" v-if="workTime.status == 1">
        <span class="time">{{format(workTime.workDate,'yyyy年MM月dd日')}}</span>
      ...
      <div class="doctor" v-else>
        ...
        <div class="moring">
          ...
          <!--每一个医生的信息-->
          <div class="hasData" v-if="moringArr.length > 0">
          ...
          <div class="noData" v-else>
            <el-empty :image-size="100" description="暂无号源"/>
          </div>
        </div>
        <!-- 下午 -->
        <div class="moring">
          ...
          <!--每一个医生的信息-->
          <div class="hasData" v-if="afterArr.length > 0">
...
import { format } from 'date-fns'; // 只导入需要的format函数
